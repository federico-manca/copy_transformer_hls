...
//------------------------Parameter----------------------
`define TV_IN_Out_r "../tv/cdatafile/c.ViT_Block.autotvin_Out_r.dat"
`define TV_OUT_Out_r "../tv/rtldatafile/rtl.ViT_Block.autotvout_Out_r.dat"
 parameter Out_r_ADDR_BITWIDTH = 32'd 64;
 parameter Out_r_AWUSER_BITWIDTH = 32'd 1;
 parameter Out_r_DATA_BITWIDTH = 32'd 32;
 parameter Out_r_WUSER_BITWIDTH = 32'd 1;
 parameter Out_r_ID_BITWIDTH = 32'd 1;
 parameter Out_r_RUSER_BITWIDTH = 32'd 1;
 parameter Out_r_BUSER_BITWIDTH = 32'd 1;
 parameter   FIFO_DEPTH            =   1 + 1;
 parameter   mem_page_num            =   32'd 4;
 parameter   FIFO_DEPTH_ADDR_WIDTH   =    32'd 32;
parameter Out_r_C_DATA_BITWIDTH = 32'd 8;
parameter Out_r_mem_depth = 32'd 256;
parameter ReadReqLatency = 32'd 1;
parameter WriteReqLatency = 32'd 1;
// Input and Output
input clk;
input reset;
input  TRAN_Out_r_AWVALID;
output  TRAN_Out_r_AWREADY;
input [Out_r_ADDR_BITWIDTH - 1 : 0] TRAN_Out_r_AWADDR;
input [Out_r_ID_BITWIDTH - 1 : 0] TRAN_Out_r_AWID;
input [8 - 1 : 0] TRAN_Out_r_AWLEN;
input [3 - 1 : 0] TRAN_Out_r_AWSIZE;
input [2 - 1 : 0] TRAN_Out_r_AWBURST;
input [2 - 1 : 0] TRAN_Out_r_AWLOCK;
input [4 - 1 : 0] TRAN_Out_r_AWCACHE;
input [3 - 1 : 0] TRAN_Out_r_AWPROT;
input [4 - 1 : 0] TRAN_Out_r_AWQOS;
input [4 - 1 : 0] TRAN_Out_r_AWREGION;
input [Out_r_AWUSER_BITWIDTH - 1 : 0] TRAN_Out_r_AWUSER;
input  TRAN_Out_r_WVALID;
output  TRAN_Out_r_WREADY;
input [Out_r_DATA_BITWIDTH - 1 : 0] TRAN_Out_r_WDATA;
input [Out_r_DATA_BITWIDTH/8 - 1 : 0] TRAN_Out_r_WSTRB;
input  TRAN_Out_r_WLAST;
input  TRAN_Out_r_WID;
input [Out_r_WUSER_BITWIDTH - 1 : 0] TRAN_Out_r_WUSER;
input  TRAN_Out_r_ARVALID;
output  TRAN_Out_r_ARREADY;
input [Out_r_ADDR_BITWIDTH - 1 : 0] TRAN_Out_r_ARADDR;
input [Out_r_ID_BITWIDTH - 1 : 0] TRAN_Out_r_ARID;
input [8 - 1 : 0] TRAN_Out_r_ARLEN;
input [3 - 1 : 0] TRAN_Out_r_ARSIZE;
input [2 - 1 : 0] TRAN_Out_r_ARBURST;
input [2 - 1 : 0] TRAN_Out_r_ARLOCK;
input [4 - 1 : 0] TRAN_Out_r_ARCACHE;
input [3 - 1 : 0] TRAN_Out_r_ARPROT;
input [4 - 1 : 0] TRAN_Out_r_ARQOS;
input [4 - 1 : 0] TRAN_Out_r_ARREGION;
input  TRAN_Out_r_ARUSER;
output  TRAN_Out_r_RVALID;
input  TRAN_Out_r_RREADY;
output [Out_r_DATA_BITWIDTH - 1 : 0] TRAN_Out_r_RDATA;
output  TRAN_Out_r_RLAST;
output [Out_r_ID_BITWIDTH - 1 : 0] TRAN_Out_r_RID;
output [Out_r_RUSER_BITWIDTH - 1 : 0] TRAN_Out_r_RUSER;
output [2 - 1 : 0] TRAN_Out_r_RRESP;
output  TRAN_Out_r_BVALID;
input  TRAN_Out_r_BREADY;
output [2 - 1 : 0] TRAN_Out_r_BRESP;
output [Out_r_ID_BITWIDTH - 1 : 0] TRAN_Out_r_BID;
output [Out_r_BUSER_BITWIDTH - 1 : 0] TRAN_Out_r_BUSER;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [Out_r_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [Out_r_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [Out_r_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [Out_r_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [Out_r_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [Out_r_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg    BRESP_tmp = 0;
reg    [Out_r_ID_BITWIDTH - 1 : 0] BID_tmp = 0;
reg    send_one_BRESP = 0;
reg    [31 : 0] BRESP_counter = 0;

reg [Out_r_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [Out_r_ID_BITWIDTH - 1 : 0] RID_tmp = 0;
reg [Out_r_DATA_BITWIDTH - 1 : 0] Out_r_mem_0 [0: Out_r_mem_depth - 1] = '{default : 'h0}; 
reg [Out_r_DATA_BITWIDTH - 1 : 0] Out_r_mem_1 [0: Out_r_mem_depth - 1] = '{default : 'h0}; 
reg [Out_r_DATA_BITWIDTH - 1 : 0] Out_r_mem_2 [0: Out_r_mem_depth - 1] = '{default : 'h0}; 
reg [Out_r_DATA_BITWIDTH - 1 : 0] Out_r_mem_3 [0: Out_r_mem_depth - 1] = '{default : 'h0}; 
reg [31 : 0] clk_counter ;
reg [31 : 0] current_AW_req_transaction = 0 ;
reg [31 : 0] current_AR_req_transaction = -1 ;
reg write_processing = 0;
reg [Out_r_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [Out_r_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [Out_r_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_Out_r_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_Out_r_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_Out_r_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_Out_r_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_Out_r_BRESP = BRESP_tmp;
assign TRAN_Out_r_BID = BID_tmp;
assign TRAN_Out_r_RDATA = RDATA_tmp;
assign TRAN_Out_r_RRESP = RRESP_tmp;
assign TRAN_Out_r_RLAST = RLAST_tmp;
assign TRAN_Out_r_RID = RID_tmp;
assign TRAN_Out_r_RVALID = RVALID_tmp;

initial begin : initialize_offset
  integer DATA_byte_num; 
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = Out_r_C_DATA_BITWIDTH;
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_Out_r_AWREADY & TRAN_Out_r_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_Out_r_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_Out_r_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_Out_r_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_Out_r_AWBURST; 
            FIFO_AW_req_ID[FIFO_AW_req_ptr_w]    =   TRAN_Out_r_AWID; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_Out_r_ARREADY & TRAN_Out_r_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_Out_r_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_Out_r_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_Out_r_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_Out_r_ARBURST; 
            FIFO_AR_req_ID[FIFO_AR_req_ptr_w]    =   TRAN_Out_r_ARID; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_Out_r_WREADY & TRAN_Out_r_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_Out_r_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_Out_r_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_Out_r_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_Out_r_AWVALID && TRAN_Out_r_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_Out_r_ARVALID && TRAN_Out_r_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_Out_r_WVALID && TRAN_Out_r_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_Out_r_WVALID && TRAN_Out_r_WREADY && TRAN_Out_r_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_Out_r_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_Out_r_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [Out_r_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [Out_r_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [Out_r_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > Out_r_mem_depth) begin
                $display ("/home/fede/PhD/transformer-hls/runs/mnist_vit_block_20260619_144418_0b8dc3f6/build/ViT_Block/ViT_Block/sim/verilog/AESL_axi_master_Out_r.v: Write request address %d exceed AXI master Out_r array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, Out_r_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AW_req_BURST_tmp === 1) begin
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = Out_r_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        1 : WDATA_tmp[j] = Out_r_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        2 : WDATA_tmp[j] = Out_r_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        3 : WDATA_tmp[j] = Out_r_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : Out_r_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            1 : Out_r_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            2 : Out_r_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            3 : Out_r_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = Out_r_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        1 : WDATA_tmp[j] = Out_r_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        2 : WDATA_tmp[j] = Out_r_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        3 : WDATA_tmp[j] = Out_r_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        wr_processing_data = WDATA_tmp;
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : Out_r_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            1 : Out_r_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            2 : Out_r_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            3 : Out_r_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
...
initial begin : AR_request_proc
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > Out_r_mem_depth) begin
                $display ("/home/fede/PhD/transformer-hls/runs/mnist_vit_block_20260619_144418_0b8dc3f6/build/ViT_Block/ViT_Block/sim/verilog/AESL_axi_master_Out_r.v: Read request address %d exceed AXI master Out_r array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, Out_r_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= Out_r_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            1 : RDATA_tmp <= Out_r_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            2 : RDATA_tmp <= Out_r_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            3 : RDATA_tmp <= Out_r_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_Out_r_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= Out_r_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            1 : RDATA_tmp <= Out_r_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            2 : RDATA_tmp <= Out_r_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            3 : RDATA_tmp <= Out_r_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
...
initial begin : read_file_process 
  ...
  integer mem_page; 
  integer Out_r_bitwidth; 
  reg [8 - 1 : 0] token_tmp; 
  reg [Out_r_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  Out_r_bitwidth = Out_r_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (Out_r_bitwidth , factor);
  fp = $fopen(`TV_IN_Out_r,"rb"); 
  ...
  while (trans_depth != 64'h5a5aa5a50f0ff0f0)  begin
      ...
      mem_tmp [Out_r_DATA_BITWIDTH - 1: 0] = 0;
      for(i = 0; i < Out_r_mem_depth; i = i + 1) begin 
          ...
          if (factor == 4) begin
              ...
              if (i%factor == 3) begin
                  ...
                  case(mem_page)
                      0 : Out_r_mem_0[i/factor] = mem_tmp;
                      1 : Out_r_mem_1[i/factor] = mem_tmp;
                      2 : Out_r_mem_2[i/factor] = mem_tmp;
                      3 : Out_r_mem_3[i/factor] = mem_tmp;
          ...
          if (factor == 1) begin
              mem_tmp = token_tmp;
              case(mem_page)
                  0 : Out_r_mem_0[i] = mem_tmp;
                  1 : Out_r_mem_1[i] = mem_tmp;
                  2 : Out_r_mem_2[i] = mem_tmp;
                  3 : Out_r_mem_3[i] = mem_tmp;
                  default: $display("The page_num of read file is not valid!");
              endcase
              mem_tmp [Out_r_DATA_BITWIDTH - 1: 0] = 0;
          end
