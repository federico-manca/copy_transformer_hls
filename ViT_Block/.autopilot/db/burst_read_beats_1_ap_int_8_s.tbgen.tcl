set moduleName burst_read_beats_1_ap_int_8_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {burst_read_beats<1, ap_int<8> >}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 8 regular {axi_master 0}  }
	{ W_ddr int 64 regular  }
	{ burst_reads2 int 8 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in_w_down","offset": { "type": "dynamic","port_name": "in_w_down","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "W_ddr", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "burst_reads2", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ W_ddr sc_in sc_lv 64 signal 1 } 
	{ burst_reads2_din sc_out sc_lv 8 signal 2 } 
	{ burst_reads2_full_n sc_in sc_logic 1 signal 2 } 
	{ burst_reads2_write sc_out sc_logic 1 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "W_ddr", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "W_ddr", "role": "default" }} , 
 	{ "name": "burst_reads2_din", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "burst_reads2", "role": "din" }} , 
 	{ "name": "burst_reads2_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "burst_reads2", "role": "full_n" }} , 
 	{ "name": "burst_reads2_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "burst_reads2", "role": "write" }}  ]}
...
set Spec2ImplPortList { 
	...
	W_ddr { ap_none {  { W_ddr in_data 0 64 } } }
	burst_reads2 { ap_fifo {  { burst_reads2_din fifo_port_we 1 8 }  { burst_reads2_full_n fifo_status 0 1 }  { burst_reads2_write fifo_data 1 1 } } }
}
