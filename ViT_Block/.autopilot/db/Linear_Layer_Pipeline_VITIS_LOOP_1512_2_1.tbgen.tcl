...
set C_modelArgList {
	{ C_tile_V int 32 regular {array 64 { 0 3 } 0 1 }  }
}
...
set Spec2ImplPortList { 
	C_tile_V { ap_memory {  { C_tile_V_address0 mem_address 1 6 }  { C_tile_V_ce0 mem_ce 1 1 }  { C_tile_V_we0 mem_we 1 1 }  { C_tile_V_d0 mem_din 1 32 } } }
}
