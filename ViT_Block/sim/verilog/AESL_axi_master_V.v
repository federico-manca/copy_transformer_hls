...
//------------------------Parameter----------------------
`define TV_IN_V "../tv/cdatafile/c.ViT_Block.autotvin_V.dat"
`define TV_OUT_V "../tv/rtldatafile/rtl.ViT_Block.autotvout_V.dat"
 parameter V_ADDR_BITWIDTH = 32'd 64;
 parameter V_AWUSER_BITWIDTH = 32'd 1;
 parameter V_DATA_BITWIDTH = 32'd 32;
 parameter V_WUSER_BITWIDTH = 32'd 1;
 parameter V_ID_BITWIDTH = 32'd 1;
 parameter V_RUSER_BITWIDTH = 32'd 1;
 parameter V_BUSER_BITWIDTH = 32'd 1;
 parameter   FIFO_DEPTH            =   1 + 1;
 parameter   mem_page_num            =   32'd 4;
 parameter   FIFO_DEPTH_ADDR_WIDTH   =    32'd 32;
parameter V_C_DATA_BITWIDTH = 32'd 8;
parameter V_mem_depth = 32'd 256;
parameter ReadReqLatency = 32'd 1;
parameter WriteReqLatency = 32'd 1;
// Input and Output
input clk;
input reset;
input  TRAN_V_AWVALID;
output  TRAN_V_AWREADY;
input [V_ADDR_BITWIDTH - 1 : 0] TRAN_V_AWADDR;
input [V_ID_BITWIDTH - 1 : 0] TRAN_V_AWID;
input [8 - 1 : 0] TRAN_V_AWLEN;
input [3 - 1 : 0] TRAN_V_AWSIZE;
input [2 - 1 : 0] TRAN_V_AWBURST;
input [2 - 1 : 0] TRAN_V_AWLOCK;
input [4 - 1 : 0] TRAN_V_AWCACHE;
input [3 - 1 : 0] TRAN_V_AWPROT;
input [4 - 1 : 0] TRAN_V_AWQOS;
input [4 - 1 : 0] TRAN_V_AWREGION;
input [V_AWUSER_BITWIDTH - 1 : 0] TRAN_V_AWUSER;
input  TRAN_V_WVALID;
output  TRAN_V_WREADY;
input [V_DATA_BITWIDTH - 1 : 0] TRAN_V_WDATA;
input [V_DATA_BITWIDTH/8 - 1 : 0] TRAN_V_WSTRB;
input  TRAN_V_WLAST;
input  TRAN_V_WID;
input [V_WUSER_BITWIDTH - 1 : 0] TRAN_V_WUSER;
input  TRAN_V_ARVALID;
output  TRAN_V_ARREADY;
input [V_ADDR_BITWIDTH - 1 : 0] TRAN_V_ARADDR;
input [V_ID_BITWIDTH - 1 : 0] TRAN_V_ARID;
input [8 - 1 : 0] TRAN_V_ARLEN;
input [3 - 1 : 0] TRAN_V_ARSIZE;
input [2 - 1 : 0] TRAN_V_ARBURST;
input [2 - 1 : 0] TRAN_V_ARLOCK;
input [4 - 1 : 0] TRAN_V_ARCACHE;
input [3 - 1 : 0] TRAN_V_ARPROT;
input [4 - 1 : 0] TRAN_V_ARQOS;
input [4 - 1 : 0] TRAN_V_ARREGION;
input  TRAN_V_ARUSER;
output  TRAN_V_RVALID;
input  TRAN_V_RREADY;
output [V_DATA_BITWIDTH - 1 : 0] TRAN_V_RDATA;
output  TRAN_V_RLAST;
output [V_ID_BITWIDTH - 1 : 0] TRAN_V_RID;
output [V_RUSER_BITWIDTH - 1 : 0] TRAN_V_RUSER;
output [2 - 1 : 0] TRAN_V_RRESP;
output  TRAN_V_BVALID;
input  TRAN_V_BREADY;
output [2 - 1 : 0] TRAN_V_BRESP;
output [V_ID_BITWIDTH - 1 : 0] TRAN_V_BID;
output [V_BUSER_BITWIDTH - 1 : 0] TRAN_V_BUSER;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [V_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [V_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [V_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [V_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [V_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [V_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg    BRESP_tmp = 0;
reg    [V_ID_BITWIDTH - 1 : 0] BID_tmp = 0;
reg    send_one_BRESP = 0;
reg    [31 : 0] BRESP_counter = 0;

reg [V_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [V_ID_BITWIDTH - 1 : 0] RID_tmp = 0;
reg [V_DATA_BITWIDTH - 1 : 0] V_mem_0 [0: V_mem_depth - 1] = '{default : 'h0}; 
reg [V_DATA_BITWIDTH - 1 : 0] V_mem_1 [0: V_mem_depth - 1] = '{default : 'h0}; 
reg [V_DATA_BITWIDTH - 1 : 0] V_mem_2 [0: V_mem_depth - 1] = '{default : 'h0}; 
reg [V_DATA_BITWIDTH - 1 : 0] V_mem_3 [0: V_mem_depth - 1] = '{default : 'h0}; 
reg [31 : 0] clk_counter ;
reg [31 : 0] current_AW_req_transaction = 0 ;
reg [31 : 0] current_AR_req_transaction = -1 ;
reg write_processing = 0;
reg [V_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [V_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [V_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_V_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_V_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_V_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_V_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_V_BRESP = BRESP_tmp;
assign TRAN_V_BID = BID_tmp;
assign TRAN_V_RDATA = RDATA_tmp;
assign TRAN_V_RRESP = RRESP_tmp;
assign TRAN_V_RLAST = RLAST_tmp;
assign TRAN_V_RID = RID_tmp;
assign TRAN_V_RVALID = RVALID_tmp;

initial begin : initialize_offset
  integer DATA_byte_num; 
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = V_C_DATA_BITWIDTH;
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_V_AWREADY & TRAN_V_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_V_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_V_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_V_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_V_AWBURST; 
            FIFO_AW_req_ID[FIFO_AW_req_ptr_w]    =   TRAN_V_AWID; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_V_ARREADY & TRAN_V_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_V_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_V_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_V_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_V_ARBURST; 
            FIFO_AR_req_ID[FIFO_AR_req_ptr_w]    =   TRAN_V_ARID; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_V_WREADY & TRAN_V_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_V_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_V_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_V_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_V_AWVALID && TRAN_V_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_V_ARVALID && TRAN_V_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_V_WVALID && TRAN_V_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_V_WVALID && TRAN_V_WREADY && TRAN_V_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_V_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_V_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [V_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [V_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [V_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > V_mem_depth) begin
                $display ("/home/fede/PhD/transformer-hls/runs/mnist_vit_block_20260619_144418_0b8dc3f6/build/ViT_Block/ViT_Block/sim/verilog/AESL_axi_master_V.v: Write request address %d exceed AXI master V array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, V_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AW_req_BURST_tmp === 1) begin
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = V_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        1 : WDATA_tmp[j] = V_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        2 : WDATA_tmp[j] = V_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        3 : WDATA_tmp[j] = V_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : V_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            1 : V_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            2 : V_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            3 : V_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = V_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        1 : WDATA_tmp[j] = V_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        2 : WDATA_tmp[j] = V_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        3 : WDATA_tmp[j] = V_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        wr_processing_data = WDATA_tmp;
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : V_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            1 : V_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            2 : V_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            3 : V_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
...
initial begin : AR_request_proc
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > V_mem_depth) begin
                $display ("/home/fede/PhD/transformer-hls/runs/mnist_vit_block_20260619_144418_0b8dc3f6/build/ViT_Block/ViT_Block/sim/verilog/AESL_axi_master_V.v: Read request address %d exceed AXI master V array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, V_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= V_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            1 : RDATA_tmp <= V_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            2 : RDATA_tmp <= V_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            3 : RDATA_tmp <= V_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_V_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= V_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            1 : RDATA_tmp <= V_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            2 : RDATA_tmp <= V_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            3 : RDATA_tmp <= V_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
...
initial begin : read_file_process 
  ...
  integer V_bitwidth; 
  reg [8 - 1 : 0] token_tmp; 
  reg [V_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  V_bitwidth = V_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (V_bitwidth , factor);
  fp = $fopen(`TV_IN_V,"rb"); 
  ...
  while (trans_depth != 64'h5a5aa5a50f0ff0f0)  begin
      ...
      mem_tmp [V_DATA_BITWIDTH - 1: 0] = 0;
      for(i = 0; i < V_mem_depth; i = i + 1) begin 
          ...
          if (factor == 4) begin
              ...
              if (i%factor == 3) begin
                  ...
                  case(mem_page)
                      0 : V_mem_0[i/factor] = mem_tmp;
                      1 : V_mem_1[i/factor] = mem_tmp;
                      2 : V_mem_2[i/factor] = mem_tmp;
                      3 : V_mem_3[i/factor] = mem_tmp;
