...
set hasInterrupt 0
set C_modelName {axis_to_apuint}
...
set C_modelArgList {
	...
	{ input_stream1 int 8 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_r_V_data_V", "interface" : "axis", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "input_stream1", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ input_stream1_din sc_out sc_lv 8 signal 4 } 
	{ input_stream1_num_data_valid sc_in sc_lv 2 signal 4 } 
	{ input_stream1_fifo_cap sc_in sc_lv 2 signal 4 } 
	{ input_stream1_full_n sc_in sc_logic 1 signal 4 } 
	{ input_stream1_write sc_out sc_logic 1 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input_stream1_din", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "input_stream1", "role": "din" }} , 
 	...
 	{ "name": "input_stream1_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "input_stream1", "role": "full_n" }} , 
 	{ "name": "input_stream1_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "input_stream1", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"Port" : [
			...
			{"Name" : "input_stream1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0","0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	input_stream1 { ap_fifo {  { input_stream1_din fifo_port_we 1 8 }  { input_stream1_num_data_valid fifo_status_num_data_valid 0 2 }  { input_stream1_fifo_cap fifo_update 0 2 }  { input_stream1_full_n fifo_status 0 1 }  { input_stream1_write fifo_data 1 1 } } }
}
