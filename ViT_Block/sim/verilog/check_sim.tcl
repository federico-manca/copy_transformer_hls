...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.ViT_Block.autotvin_Q.dat"
         "c.ViT_Block.autotvin_K.dat"
         "c.ViT_Block.autotvin_V.dat"
         "c.ViT_Block.autotvin_Out_r.dat"
         "c.ViT_Block.autotvin_gmem0.dat"
         "c.ViT_Block.autotvin_gmem1.dat"
         "c.ViT_Block.autotvin_in_r_V_data_V.dat"
         "c.ViT_Block.autotvin_in_r_V_keep_V.dat"
         "c.ViT_Block.autotvin_in_r_V_strb_V.dat"
         "c.ViT_Block.autotvin_in_r_V_last_V.dat"
         "c.ViT_Block.autotvin_in_q.dat"
         "c.ViT_Block.autotvin_in_k.dat"
         "c.ViT_Block.autotvin_in_v.dat"
         "c.ViT_Block.autotvin_in_o.dat"
         "c.ViT_Block.autotvin_in_w_up.dat"
         "c.ViT_Block.autotvin_in_w_down.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.ViT_Block.autotvout_out_r_V_data_V.dat"
         "rtl.ViT_Block.autotvout_out_r_V_keep_V.dat"
         "rtl.ViT_Block.autotvout_out_r_V_strb_V.dat"
         "rtl.ViT_Block.autotvout_out_r_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
