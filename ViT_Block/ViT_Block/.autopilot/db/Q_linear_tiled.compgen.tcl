...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler ViT_Block_fifo_w8_d64_S_x BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {out_w_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler ViT_Block_start_for_Linear_Layer_17_192_192_1_1_1_1_1_1_98_16_0_ap_int_ap_int_ap_int_U0 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {start_for_Linear_Layer_17_192_192_1_1_1_1_1_1_98_16_0_ap_int_ap_int_ap_int_U0_U}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_Q_in5 \
    op interface \
    ports { Q_in5_dout { I 8 vector } Q_in5_empty_n { I 1 bit } Q_in5_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_q_lin1 \
    op interface \
    ports { q_lin1_din { O 8 vector } q_lin1_full_n { I 1 bit } q_lin1_write { O 1 bit } } \
} "
}
