...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler ViT_Block_fifo_w8_d64_S_x2 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {out_w_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler ViT_Block_start_for_Linear_Layer_17_16_16_1_1_1_1_1_1_409_16_0_ap_int_ap_int_ap_int_U0 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {start_for_Linear_Layer_17_16_16_1_1_1_1_1_1_409_16_0_ap_int_ap_int_ap_int_U0_U}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_V_in7 \
    op interface \
    ports { V_in7_dout { I 8 vector } V_in7_empty_n { I 1 bit } V_in7_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_v_lin3 \
    op interface \
    ports { v_lin3_din { O 8 vector } v_lin3_full_n { I 1 bit } v_lin3_write { O 1 bit } } \
} "
}
