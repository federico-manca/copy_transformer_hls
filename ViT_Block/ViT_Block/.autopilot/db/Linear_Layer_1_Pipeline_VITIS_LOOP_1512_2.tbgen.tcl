set moduleName Linear_Layer_1_Pipeline_VITIS_LOOP_1512_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Linear_Layer.1_Pipeline_VITIS_LOOP_1512_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ C_tile_V int 32 regular {array 768 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "C_tile_V", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.bias_1_0_V_U", "Parent" : "0"},
...
set Spec2ImplPortList { 
	C_tile_V { ap_memory {  { C_tile_V_address0 mem_address 1 10 }  { C_tile_V_ce0 mem_ce 1 1 }  { C_tile_V_we0 mem_we 1 1 }  { C_tile_V_d0 mem_din 1 32 } } }
}
