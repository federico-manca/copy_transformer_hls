...
entity ViT_Block_fifo_w8_d3072_A is
    generic (
...
architecture arch of ViT_Block_fifo_w8_d3072_A is

    -- component
    component ViT_Block_fifo_w8_d3072_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_ViT_Block_fifo_w8_d3072_A_ram : ViT_Block_fifo_w8_d3072_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity ViT_Block_fifo_w8_d3072_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 8;
        ADDR_WIDTH  : integer := 12;
...
architecture arch of ViT_Block_fifo_w8_d3072_A_ram is
