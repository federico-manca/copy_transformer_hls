...
set hasInterrupt 0
set C_modelName {apuint_to_axis}
set C_modelType { void 0 }
set C_modelArgList {
	{ output_stream2 int 8 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "output_stream2", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ output_stream2_dout sc_in sc_lv 8 signal 0 } 
	{ output_stream2_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ output_stream2_fifo_cap sc_in sc_lv 2 signal 0 } 
	{ output_stream2_empty_n sc_in sc_logic 1 signal 0 } 
	{ output_stream2_read sc_out sc_logic 1 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "output_stream2_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "output_stream2", "role": "dout" }} , 
 	...
 	{ "name": "output_stream2_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "output_stream2", "role": "empty_n" }} , 
 	{ "name": "output_stream2_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "output_stream2", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "output_stream2", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0","-1"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3267", "Max" : "3267"}
	, {"Name" : "Interval", "Min" : "3267", "Max" : "3267"}
]}
...
set Spec2ImplPortList { 
	output_stream2 { ap_fifo {  { output_stream2_dout fifo_port_we 0 8 }  { output_stream2_num_data_valid fifo_status_num_data_valid 0 2 }  { output_stream2_fifo_cap fifo_update 0 2 }  { output_stream2_empty_n fifo_status 0 1 }  { output_stream2_read fifo_data 1 1 } } }
