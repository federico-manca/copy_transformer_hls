...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_r_TREADY { I 1 bit } out_r_TVALID { O 1 bit } out_r_TLAST { O 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { output_stream2_dout { I 8 vector } output_stream2_num_data_valid { I 2 vector } output_stream2_fifo_cap { I 2 vector } output_stream2_empty_n { I 1 bit } output_stream2_read { O 1 bit } } \
} "
}
...
# RegSlice definition:
set ID 830
set RegSliceName ViT_Block_regslice_both
set RegSliceInstName ViT_Block_regslice_both_U
set CoreName ap_simcore_ViT_Block_regslice_both
