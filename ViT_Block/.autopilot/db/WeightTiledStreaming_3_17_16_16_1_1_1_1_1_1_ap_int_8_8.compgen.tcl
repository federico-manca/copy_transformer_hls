...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler ViT_Block_fifo_w8_d64_S_x0 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {burst_reads_U}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_out_w1 \
    op interface \
    ports { out_w1_din { O 8 vector } out_w1_num_data_valid { I 5 vector } out_w1_fifo_cap { I 5 vector } out_w1_full_n { I 1 bit } out_w1_write { O 1 bit } } \
} "
}
