...
if {[file isfile ViT_Block.autotvin.dat]} {
	file delete -force ViT_Block.autotvin.dat
}

if {[file isfile ViT_Block.autotvout.dat]} {
	file delete -force ViT_Block.autotvout.dat
}
