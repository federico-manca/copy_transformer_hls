set moduleName MatMul_QK_tiled_10_Pipeline_VITIS_LOOP_1656_1_VITIS_LOOP_1657_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {MatMul_QK_tiled.10_Pipeline_VITIS_LOOP_1656_1_VITIS_LOOP_1657_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ buff_K_V int 8 regular {array 136 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
...
set portList { 
	...
	{ buff_K_V_address0 sc_out sc_lv 8 signal 0 } 
...
set Spec2ImplPortList { 
	buff_K_V { ap_memory {  { buff_K_V_address0 mem_address 1 8 }  { buff_K_V_ce0 mem_ce 1 1 }  { buff_K_V_we0 mem_we 1 1 }  { buff_K_V_d0 mem_din 1 8 } } }
