...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler ViT_Block_fifo_w8_d64_S_x9 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {fc1_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler ViT_Block_fifo_w8_d64_S_x9 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {relu_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler ViT_Block_start_for_Relu_tiled_oc_U0 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {start_for_Relu_tiled_oc_U0_U}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_in_w_up \
    op interface \
    ports { in_w_up { I 64 vector } in_w_up_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_in_w_down \
    op interface \
    ports { in_w_down { I 64 vector } in_w_down_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mlp_out14 \
    op interface \
    ports { mlp_out14_din { O 8 vector } mlp_out14_full_n { I 1 bit } mlp_out14_write { O 1 bit } } \
} "
}
