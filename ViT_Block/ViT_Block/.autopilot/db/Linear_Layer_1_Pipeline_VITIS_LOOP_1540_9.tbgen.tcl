set moduleName Linear_Layer_1_Pipeline_VITIS_LOOP_1540_9
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Linear_Layer.1_Pipeline_VITIS_LOOP_1540_9}
set C_modelType { void 0 }
set C_modelArgList {
	{ C_tile_V int 32 regular {array 768 { 0 1 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "C_tile_V", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "lhs", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ out_w1_dout sc_in sc_lv 8 signal 1 } 
	{ out_w1_num_data_valid sc_in sc_lv 7 signal 1 } 
	{ out_w1_fifo_cap sc_in sc_lv 7 signal 1 } 
	{ out_w1_empty_n sc_in sc_logic 1 signal 1 } 
	{ out_w1_read sc_out sc_logic 1 signal 1 } 
	{ C_tile_V_address0 sc_out sc_lv 10 signal 0 } 
	{ C_tile_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ C_tile_V_we0 sc_out sc_logic 1 signal 0 } 
	{ C_tile_V_d0 sc_out sc_lv 32 signal 0 } 
	{ C_tile_V_address1 sc_out sc_lv 10 signal 0 } 
	{ C_tile_V_ce1 sc_out sc_logic 1 signal 0 } 
	{ C_tile_V_q1 sc_in sc_lv 32 signal 0 } 
	{ lhs sc_in sc_lv 8 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "C_tile_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "C_tile_V", "role": "address0" }} , 
 	...
 	{ "name": "C_tile_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "C_tile_V", "role": "address1" }} , 
 	...
 	{ "name": "lhs", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "lhs", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_8s_8s_32s_32_4_1_U730", "Parent" : "0"},
...
set Spec2ImplPortList { 
	C_tile_V { ap_memory {  { C_tile_V_address0 mem_address 1 10 }  { C_tile_V_ce0 mem_ce 1 1 }  { C_tile_V_we0 mem_we 1 1 }  { C_tile_V_d0 mem_din 1 32 }  { C_tile_V_address1 MemPortADDR2 1 10 }  { C_tile_V_ce1 MemPortCE2 1 1 }  { C_tile_V_q1 in_data 0 32 } } }
